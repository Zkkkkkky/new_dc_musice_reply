; Upper-ROM bridge: 15 existing refined commands, JUST replaced at $A0,
; and four new commands $A7-$AA.  $A6 remains disabled in the upper ROM.
...
@direct_selectors:
    ...
    bcc @check_active
    cmp #$9d
    bcc @direct_start_native
    cmp #$a0
    bcc @discard_removed_song
    cmp #$a6
    bcc @direct_start_native
    cmp #$a7
    bcc @discard_removed_song ; upper $A6 stays disabled
    cmp #$ab
    bcc @direct_start_native
    bcs @check_active
@direct_start_native:
