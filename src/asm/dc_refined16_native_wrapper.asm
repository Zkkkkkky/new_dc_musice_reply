; Refined-16 wrapper stored at $BD00 in both relocated-driver banks.
; This is the refined-15 wrapper with command $A6 mapped to data Bank $78.
...
dc_refined16_native_wrapper_end:
